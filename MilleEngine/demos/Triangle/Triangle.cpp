...
public:
	...
	void createCommandBuffers()
	{
		...
		VkCommandBufferAllocateInfo cmdBufAllocateInfo = vent::vkinitializer::commandBufferAllocateInfo(commandPool, VK_COMMAND_BUFFER_LEVEL_PRIMARY, MAX_CONCURRENT_FRAMES);
